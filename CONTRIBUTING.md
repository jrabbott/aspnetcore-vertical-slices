...
No Node.js, npm, or LibMan is required. `dotnet build` compiles SCSS and TypeScript into `wwwroot` via NuGet MSBuild packages (see [Theme and front-end assets](docs/reference/theme-and-assets.md)).
