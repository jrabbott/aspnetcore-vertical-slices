...
description: Add or extend a Vertical Slice (controller, handler, request/response, optional Razor view, and tests) under Features/. Use when creating a new use case, feature slice, MVC page, or command endpoint in this weather sample.
license: MIT
metadata:
  author: weatherapp
  version: "1.0"
...
Before coding, read [docs/how-to/add-a-feature-slice.md](../../../docs/how-to/add-a-feature-slice.md). While implementing, load [references/slice-checklist.md](references/slice-checklist.md). When writing tests for the slice, load [references/testing.md](references/testing.md).
...
6. Add unit (± integration) tests using [references/testing.md](references/testing.md); update `FeatureBoundaryTests` slice lists when namespaces change.
...
- [Test projects](../../../docs/reference/testing.md)
